...
/** `a.card.setting-toggle` in phoenix-tailwind LayoutTheme.pug */
const SettingsToggle = () => {
  ...
  return (
    <Card asChild className="setting-toggle">
      <a
      ...
      >
        <Card.Body className="flex items-center px-2 py-1">
          <div className="relative flex flex-center rounded-s-md h-8.5 w-7">
            <div className="settings-popover">
              <span className="ripple">
                <span className="fa-spin absolute inset-0 flex flex-center">
                  <span className="icon-spin absolute inset-0 flex flex-center">
                    <svg
                      width="20"
                      height="20"
                      viewBox="0 0 20 20"
